...
public class FoodIBdRider extends JFrame {
...
private void handleLogin(ActionEvent e) {
    ...
    if (isLoginSuccessful) {
		...
		FoodIBdRiderDeliveryPage foodIBdRiderFoodDeliveryPage = new FoodIBdRiderDeliveryPage();
        foodIBdRiderFoodDeliveryPage.setTitle("FoodIBd Rider Food Delivery Page");
        foodIBdRiderFoodDeliveryPage.setSize(900, 600);
        foodIBdRiderFoodDeliveryPage.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        foodIBdRiderFoodDeliveryPage.setLocationRelativeTo(null);
        foodIBdRiderFoodDeliveryPage.setVisible(true);
        foodIBdRiderFoodDeliveryPage.setResizable(false);
		this.dispose();
    } else {
