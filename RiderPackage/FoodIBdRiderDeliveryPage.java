...
public class FoodIBdRiderDeliveryPage extends JFrame {
  ...
  public FoodIBdRiderDeliveryPage() {
    setUpFoodIBdRiderDeliveryPage();
 
}

    private void setUpFoodIBdRiderDeliveryPage() {
        ...
        welcomeLabel = new JLabel("Welcome to theFoodIBd Rider Delivery Page", JLabel.CENTER);
...
private void loadFoodInventory(ActionEvent e) {
		...
		try {
			Path filePath = Paths.get("src/AdminPackage/FoodiBd Riders Orders.txt");
