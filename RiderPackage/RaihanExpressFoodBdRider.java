...
public class RaihanExpressFoodBdRider extends JFrame {
...
public RaihanExpressFoodBdRider() {
        setupRiderPage();
    }
...
private void handleLogin(ActionEvent e) {
    ...
    if (isLoginSuccessful) {
        String successMessage = "<html><div style='text-align: center;'><b>Login Successful!</b><br>Welcome to Raihan Express Bd Rider Dashboard.</div></html>";
        JOptionPane.showMessageDialog(this, successMessage, "Success", JOptionPane.INFORMATION_MESSAGE, okImg);
		
		 RaihanExpressRiderDeliveryPage raihanExpressRiderDeliveryPage = new RaihanExpressRiderDeliveryPage();
        raihanExpressRiderDeliveryPage.setTitle("RaihanExpress Rider Food Delivery Page");
        raihanExpressRiderDeliveryPage.setSize(900, 600);
        raihanExpressRiderDeliveryPage.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        raihanExpressRiderDeliveryPage.setLocationRelativeTo(null);
        raihanExpressRiderDeliveryPage.setVisible(true);
        raihanExpressRiderDeliveryPage.setResizable(false);
		this.dispose();
