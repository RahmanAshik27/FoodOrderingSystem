...
public class IEatRayRiderDeliveryPage extends JFrame {
  ...
  public IEatRayRiderDeliveryPage() {
    setUpIEatRayRiderDeliveryPage();
 
}

    private void setUpIEatRayRiderDeliveryPage() {
        ...
        welcomeLabel = new JLabel("Welcome to the IEatRay Rider Delivery Page", JLabel.CENTER);
...
private void loadFoodInventory(ActionEvent e) {
		...
		try {
			Path filePath = Paths.get("src/AdminPackage/IEatray Riders Orders.txt");
