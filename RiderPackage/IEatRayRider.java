...
public class IEatRayRider extends JFrame {
...
private void handleLogin(ActionEvent e) {
    ...
    if (isLoginSuccessful) {
        String successMessage = "<html><div style='text-align: center;'><b>Login Successful!</b><br>Welcome to FoodiBd Rider Dashboard.</div></html>";
        JOptionPane.showMessageDialog(this, successMessage, "Success", JOptionPane.INFORMATION_MESSAGE, okImg);
		
		IEatRayRiderDeliveryPage iEatRayRiderDeliveryPage = new IEatRayRiderDeliveryPage();
        iEatRayRiderDeliveryPage.setTitle("IEatRay Rider Food Delivery Page");
        iEatRayRiderDeliveryPage.setSize(900, 600);
        iEatRayRiderDeliveryPage.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        iEatRayRiderDeliveryPage.setLocationRelativeTo(null);
        iEatRayRiderDeliveryPage.setVisible(true);
        iEatRayRiderDeliveryPage.setResizable(false);
		this.dispose();
