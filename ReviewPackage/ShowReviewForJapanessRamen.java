...
public class ShowReviewForJapanessRamen extends JFrame {
...
public ShowReviewForJapanessRamen() {
        setupPage();
    ...
    private void setupPage() {
		...
		String oderMessage = "<html><div style='text-align: center;'><b>Click here for </b><br>Order Japaness Ramen (^_~) </div></html>";
        ...
        imageLabel = new JLabel(new ImageIcon("Src_ImageStore/ReviewJapanessRamen.png"));
    ...
    private void loadReviewsAndRatings() {
        File reviewFile = new File("ReviewPackage/CustomersReviewsForJapaneseRamen.txt");
