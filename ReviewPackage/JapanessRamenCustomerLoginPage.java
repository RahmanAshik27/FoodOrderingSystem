...
public class JapanessRamenCustomerLoginPage extends JFrame {
...
public JapanessRamenCustomerLoginPage() {
        
		setupJapanessRamenCustomerLoginPage();
    }

    private void setupJapanessRamenCustomerLoginPage() {
  ...
  private void handleLogin(ActionEvent e) {
    ...
    private void openCreateAccountPage(ActionEvent e) {
		...
		JapanessRamenCreateAccountPage createAccountPage = new JapanessRamenCreateAccountPage();
