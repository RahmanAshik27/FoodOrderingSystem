...
public class ReviewForJapanessRamen extends JFrame {
  ...
  public ReviewForJapanessRamen(String username) {
    ...
    private void saveReviewToFile(String username, int rating, String review) {
        File file = new File("ReviewPackage/CustomersReviewsForJapaneseRamen.txt");
        ImageIcon BlankImg = new ImageIcon("Src_ImageStore/FillAllbox.png");
