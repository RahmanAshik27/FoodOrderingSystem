...
public class ShowReviewForChikhenDumBiriyani extends JFrame {
...
public ShowReviewForChikhenDumBiriyani() {
        setupPage();
    ...
    private void setupPage() {
       ...
       ratingLabel = new JLabel("How much Our Customers like it?", JLabel.CENTER);
		...
		String oderMessage = "<html><div style='text-align: center;'><b>Click here for </b><br>Order Chikhen Dum Biriyani (^_~) </div></html>";
		orderButton = new JButton(oderMessage);
        orderButton.setBounds(60, 462, 340, 60);
        ...
        imageLabel = new JLabel(new ImageIcon("Src_ImageStore/ReviewDumBiriyani.png"));
	...
	private void ToOrderLogin(ActionEvent e) {
				...
				ChikhenDumBiriyaniCustomerLoginPage page = new ChikhenDumBiriyaniCustomerLoginPage();
				page.setTitle("Customer Food Service");
				page.setSize(900, 600);
				page.setLocationRelativeTo(null);
				page.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
