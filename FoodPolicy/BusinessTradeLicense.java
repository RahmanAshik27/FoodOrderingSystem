...
public class BusinessTradeLicense extends JFrame {
    private Container container;
    private JLabel imageLabel;
    private JButton nextButton, previousButton, backButton;

    public BusinessTradeLicense() {
        setUpBusinessTradeLicense();
    }

    private void setUpBusinessTradeLicense() {
        ...
        nextButton.setBounds(200, 505, 180, 50); 
        ...
        previousButton.setBounds(10, 505, 180, 50); 
    ...
    private void onPreviousButtonClick(ActionEvent e) {
	  ...
	  ResturentCertificate mainPage = new ResturentCertificate();
        mainPage.setTitle("Food Delivery System");
