...
public class TerminateCreammyPasta extends JFrame {
    private Container container;
    private JLabel imageLabel, titleLabel;
    private JButton nextButton,previousButton, backButton, confirmButton;

    public TerminateCreammyPasta() {
        setUpTerminateCreammyPasta();
    }

    private void setUpTerminateCreammyPasta() {
        ...
        imageLabel = new JLabel(new ImageIcon("Src_ImageStore/Creammy Pasta.png"));
