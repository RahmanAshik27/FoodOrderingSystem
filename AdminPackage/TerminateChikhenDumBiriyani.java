...
public class TerminateChikhenDumBiriyani extends JFrame {
    private Container container;
    private JLabel imageLabel, titleLabel;
    private JButton nextButton,previousButton, backButton, confirmButton;

    public TerminateChikhenDumBiriyani() {
        setUpTerminateChikhenDumBiriyani();
    }

    private void setUpTerminateChikhenDumBiriyani() {
        ...
        imageLabel = new JLabel(new ImageIcon("Src_ImageStore/ChikhenDum.png"));
    ...
    private void onNextButtonClick(ActionEvent e) {
        ...
        TerminateBeefBurger mainPage = new TerminateBeefBurger();
	...
	private void onPreviousButtonClick(ActionEvent e) {
        ...
        TerminateJapanessRamen mainPage = new TerminateJapanessRamen();
        mainPage.setTitle("Terminate Japaness Ramen");
        mainPage.setSize(300, 400);
        mainPage.setLocationRelativeTo(null);
        mainPage.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        mainPage.setVisible(true);
