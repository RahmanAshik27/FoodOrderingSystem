...
public class ShowPathaoRiderDetails extends JFrame {
    ...
    public ShowPathaoRiderDetails() {
		...
		welcomeLabel = new JLabel("Welcome to Pathao Rider Management", JLabel.CENTER);
		...
		showDetailsButton.setBounds(200, 120, 220, 40);
        ...
        scrollPane.setBounds(50, 145, 500, 250);
