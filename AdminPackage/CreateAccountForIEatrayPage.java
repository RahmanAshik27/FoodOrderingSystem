...
public class CreateAccountForIEatrayPage extends JFrame {
  ...
  public CreateAccountForIEatrayPage() {
        setupCreateAccountForIEatrayPage();
    }

  
    private void setupCreateAccountForIEatrayPage() {
        ...
        backButton.addActionListener(e -> {
				...
				IEatrayDetails iEatrayRiderDetails = new IEatrayDetails();
				iEatrayRiderDetails.setTitle("IEatray Rider Details");
				iEatrayRiderDetails.setSize(900, 600);
				iEatrayRiderDetails.setLocationRelativeTo(null);
				iEatrayRiderDetails.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				iEatrayRiderDetails.setVisible(true);
	...
	private void handleCreateAccount() {
		...
		try (BufferedReader reader = new BufferedReader(new FileReader("src/AdminPackage/IEatrayRiderDetails.txt"))) {
			String line;
		...
		try (PrintWriter writer = new PrintWriter(new FileWriter("src/AdminPackage/IEatrayRiderDetails.txt", true))) {
			...
			IEatrayDetails nextFrame = new IEatrayDetails();
			nextFrame.setTitle("IEatray Rider Details");
