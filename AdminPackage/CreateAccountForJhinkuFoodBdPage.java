...
public class CreateAccountForJhinkuFoodBdPage extends JFrame {
  ...
  public CreateAccountForJhinkuFoodBdPage() {
        setupCreateAccountForJhinkuFoodBdPage();
    }

  
    private void setupCreateAccountForJhinkuFoodBdPage() {
	...
	private void handleCreateAccount() {
		...
		try (BufferedReader reader = new BufferedReader(new FileReader("AdminPackage/JhinkuFoodBdRiderDetails.txt"))) {
			String line;
		...
		try (PrintWriter writer = new PrintWriter(new FileWriter("AdminPackage/JhinkuFoodBdRiderDetails.txt", true))) {
			...
			JhinkuFoodBdDetails nextFrame = new JhinkuFoodBdDetails();
			nextFrame.setTitle("JhinkuFoodBd Rider Details");
