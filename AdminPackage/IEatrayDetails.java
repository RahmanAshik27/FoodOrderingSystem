...
public class IEatrayDetails extends JFrame {
    ...
    public IEatrayDetails() {
        setupIEatrayRiderDetails();
    }

    private void setupIEatrayRiderDetails() {
        ...
        welcomeLabel = new JLabel("Welcome to the IEatray Rider Managemnet Page", JLabel.CENTER);
        ...
        loginButton = new JButton("IEatray Rider Details");
   ...
   private void goBack(ActionEvent e) {
    ...
    private void openCreateAccountPage(ActionEvent e) {
		...
		CreateAccountForIEatrayPage createAccountForIEatrayPage = new CreateAccountForIEatrayPage();
        createAccountForIEatrayPage.setTitle("Create Account");
        createAccountForIEatrayPage.setSize(900, 600);
