...
public class ShowJhinkuFoodBdDetails extends JFrame {
    ...
    public ShowJhinkuFoodBdDetails() {
		...
		welcomeLabel = new JLabel("Welcome to JhinkuFood Bd Rider Management", JLabel.CENTER);
	...
	private void goBack(ActionEvent e) {
			...
			JhinkuFoodBdDetails jhinkuFoodBdDetails = new JhinkuFoodBdDetails();
			jhinkuFoodBdDetails.setTitle("Customer Login");
			jhinkuFoodBdDetails.setSize(900, 600);
			jhinkuFoodBdDetails.setLocationRelativeTo(null);
			jhinkuFoodBdDetails.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			jhinkuFoodBdDetails.setVisible(true);
    }
