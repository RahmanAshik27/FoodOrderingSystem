...
public class CreateAccountForRaihanExpressBdPage extends JFrame {
  ...
  public CreateAccountForRaihanExpressBdPage() {
        setupCreateAccountForRaihanExpressBdPage();
    }

  
    private void setupCreateAccountForRaihanExpressBdPage() {
	...
	private void handleCreateAccount() {
		...
		try (PrintWriter writer = new PrintWriter(new FileWriter("AdminPackage/RaihanExpressBdRiderDetails.txt", true))) {
			...
			RaihanExpressDetails nextFrame = new RaihanExpressDetails();
			nextFrame.setTitle("RaihanExpressBd Rider Details");
