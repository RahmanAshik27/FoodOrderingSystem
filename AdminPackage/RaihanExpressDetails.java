...
public class RaihanExpressDetails extends JFrame {
    ...
    public RaihanExpressDetails() {
        setupRaihanExpressRiderDetails();
    }

    private void setupRaihanExpressRiderDetails() {
        ...
        welcomeLabel = new JLabel("Welcome to the Raihan Express Rider Managemnet Page", JLabel.CENTER);
   ...
   private void goBack(ActionEvent e) {
    ...
    private void openCreateAccountPage(ActionEvent e) {
		...
		CreateAccountForRaihanExpressBdPage createAccountForRaihanExpressPage = new CreateAccountForRaihanExpressBdPage();
        createAccountForRaihanExpressPage.setTitle("Create Account");
        createAccountForRaihanExpressPage.setSize(900, 600);
