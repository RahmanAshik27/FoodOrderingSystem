...
public class CreateAccountForFoodiBdPage extends JFrame {
  ...
  public CreateAccountForFoodiBdPage() {
        setupCreateAccountForFoodiBdPage();
    }

  
    private void setupCreateAccountForFoodiBdPage() {
        ...
        backButton.addActionListener(e -> {
				...
				FoodiBdDetails foodiBdRiderDetails = new FoodiBdDetails();
				foodiBdRiderDetails.setTitle("FoodiBd Rider Details");
				foodiBdRiderDetails.setSize(900, 600);
				foodiBdRiderDetails.setLocationRelativeTo(null);
				foodiBdRiderDetails.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	...
	private void handleCreateAccount() {
		...
		try (PrintWriter writer = new PrintWriter(new FileWriter("src/AdminPackage/FoodiBdRiderDetails.txt", true))) {
			...
			FoodiBdDetails nextFrame = new FoodiBdDetails();
			nextFrame.setTitle("FoodiBd Rider Details");
